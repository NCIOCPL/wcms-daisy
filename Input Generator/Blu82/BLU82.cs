...
namespace Blu82
{
    class BLU82
    {
        ...
        {
            //Adding Cheap and Dirty Task List output here. 
            //Daisy requires a "driver" script that contains a set of tasks to be performed
            //by Daisy.  Unfortunately, when this program was first created, Daisy did not require
            //this.  This means that the driver script had to be generated by hand, and this is
            //a semi-time consuming process.  So for the interem, we will generate a quick and dirty
            //version of the script.  A future release should reuse the same serializable classes used
            //by daisy to generate this script.  

            MigrationDriver driver = new MigrationDriver();
            //Reset monikers is first step.
            driver.Add(new MigrationTask()
            {
                Name = "Reset system",
                MigrationTaskType = MigrationTaskTypes.Reset
            });
            ...
            if (folderList.Count > 0)
            {
                ...
                driver.Add(new MigrationTask()
                {
                    MigrationTaskType = MigrationTaskTypes.FolderCreator,
                    Name="foldercreator",
                    Filename="folder.xml"
                });
            }
            ...
            if (newSiteCommunity.Count > 0)
            {
                ...
                driver.Add(new MigrationTask()
                {
                    MigrationTaskType = MigrationTaskTypes.GeneralContentCreator,
                    Name = "create_new_site_items",
                    Filename = "newSiteContentItems.xml"
                });
            ...
            if (newSiteAdminCommunity.Count > 0) {
                ...
                {
                    MigrationTaskType = MigrationTaskTypes.GeneralContentCreator,
                    Name = "create_new_siteAdmin_items",
                    Filename = "newSiteAdminContentItems.xml"
                });
            ...
            if (newCTBAdminCommunity.Count > 0) {
                ...
                {
                    MigrationTaskType = MigrationTaskTypes.GeneralContentCreator,
                    Name = "create_new_CTBAdmin_items",
                    Filename = "newCTBAdminContentItems.xml"
                });
            ...
            if (updateSiteCommunity.Count > 0) {
                ...
                driver.Add(new MigrationTask()
                {
                    ...
                    Name = "update_site_items",
                    Filename = "updateSiteContentItems.xml"
                });
            ...
            if (updateSiteAdminCommunity.Count > 0)
            {
                ...
                {
                    MigrationTaskType = MigrationTaskTypes.ContentUpdater,
                    Name = "update_siteAdmin_items",
                    Filename = "updateSiteAdminContentItems.xml"
                });
            ...
            if (updateCTBAdminCommunity.Count > 0) {
                ...
                {
                    MigrationTaskType = MigrationTaskTypes.ContentUpdater,
                    Name = "update_CTBAdmin_items",
                    Filename = "updateCTBAdminContentItems.xml"
                });
            }
            else
            {
            ...
            if (shareItems.Count() > 0)
            {
                ...
                driver.Add(new MigrationTask()
                {
                    MigrationTaskType = MigrationTaskTypes.LinkToFolder,
                    Name = "shareTo",
                    Filename = "shareTo.xml"
                });
            }
            else
            {
            ...
            if (relationships.Count() > 0)
            {
                ...
                driver.Add(new MigrationTask()
                {
                    MigrationTaskType = MigrationTaskTypes.RelationshipCreator,
                    Name = "relationships",
                    Filename = "relationships.xml"
                });
            ...
            using (FileStream fs = new FileStream(@".\_MainScript.xml", FileMode.Create))
            {
                using (StreamWriter writer = new StreamWriter(fs, Encoding.UTF8))
                {
                    writer.WriteLine(driver.ToXML());
                }
            }
